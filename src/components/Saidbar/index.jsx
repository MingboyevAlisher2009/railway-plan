...
const saidbarItem = [
  ...
  },
  {
    ...
    label: "Yo'l Birigadalar Ro'yxati",
    route: "/super-admin/jadval",
  },
  {
    img: (
      <svg
    ...
    label: "Kuzatuvchilar Ro'yxati",
    route: "/super-admin/kuzatuv",
  },
  {
    img: (
      <svg
