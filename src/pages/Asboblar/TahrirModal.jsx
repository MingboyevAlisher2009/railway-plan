...
const TahrirModal = ({AddTahrirModal}) => {
  return (
    <div>
      <div className="bg-black/50 flex items-center justify-center fixed w-full z-50 left-0 top-0 h-full">
        ...
        >
          <div
            tabindex="-1"
            class="relative bg-white m-4 rounded-lg shadow-2xl text-blue-gray-500 antialiased font-sans text-base font-light leading-relaxed w-full md:w-3/4 lg:w-3/5 2xl:w-2/5 min-w-[90%] md:min-w-[75%] lg:min-w-[60%] 2xl:min-w-[40%] max-w-[50%] md:max-w-[75%] lg:max-w-[60%] 2xl:max-w-[40%]"
            aria-labelledby=":r27:-label"
            aria-describedby=":r27:-description"
            id=":r28:"
            role="dialog"
          >
